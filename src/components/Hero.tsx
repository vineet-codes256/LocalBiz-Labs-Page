    ...
    return (
        <section id="home" className="relative max-w-6xl mx-auto py-20 md:py-24 px-4 sm:px-6 text-center" style={{ perspective: '1000px' }}>
            <motion.h1
                ...
                className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-orange-600 mb-4 mt-6 bg-gradient-to-r from-orange-600 to-orange-800 bg-clip-text text-transparent leading-tight"
            >
                Get Your Business Online in 7 Days - Build Website, Web Design, Apps & More.
            </motion.h1>
